...
exports.runStatementIfValidDevice = function(uuid, passphrase, resolve, reject) { // NOTE: This function is not being used at the moment, althoe it will be used in the future
...
exports.loadDevice = function(nickname, uuid, passphrase, resolve, reject) {
        getDeviceIfExists(uuid, function(result) {
            if (result['device.passphrase'] == passphrase) {
    ...
    /*
    exports.availablePeersChanged = function(peerList, updateVersion) {

    }
    */

exports.getNicknameForUUID = function(uuid, resolve, reject) {
...
exports.changeAvailablePeers = function(uuid, passphrase, change, isAddition, fullList, updateVersion, resolve, reject) {
...
exports.disconnectDevice = function(uuid, resolve, reject) {
